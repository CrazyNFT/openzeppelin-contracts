pragma solidity ^0.8.0;
    import 'https://github.com/CrazyNFT/openzeppelin-contracts/blob/master/contracts/utils/math/SafeMath.sol';
    contract BasicMetaTransaction {

    using SafeMath for uint256;

    event MetaTransactionExecuted(address userAddress, address from , bytes functionSignature);
